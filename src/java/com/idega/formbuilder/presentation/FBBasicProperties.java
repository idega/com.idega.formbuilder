...
public class FBBasicProperties extends IWBaseComponent {
	...
	protected void initializeComponent(FacesContext context) {
		...
		requiredS.setActionListener(application.createMethodBinding("#{selectHeaderAction.processAction}", new Class[]{ActionEvent.class}));
//		requiredS.setAction(application.createMethodBinding("#{savePropertiesAction.saveProperties}", null));
		requiredS.setAjaxSingle(true);
//		requiredS.setOnsubmit("alert('SH')");
//		requiredS.setOncomplete("alert('SH checkbox done')");
